...
def detect(img, classifier, scale, minNeighbour, text, color, font_family, thickness):
    img = draw_rectangle(img, classifier, scale, minNeighbour, text, color, font_family, thickness)
    return img
...
while True:
    ...
    detect(img, faceCascade, 1.1, 10, 'Face', (255,0,0), cv2.FONT_HERSHEY_SIMPLEX, 2)
